...
Manufacturers often follow the IEEE standard \cite{} and specify their IMU's typical stochastic errors through either selected ASD parameters or and ASD plot (see Fig. \ref{fig:ASD_plot_N_B}). 
...
\begin{enumerate}
	\item Find the portion of the ASD graph that has a slope of -1/2. Draw a tangent line, and define \blue phase random walk parameter $N$ \black as the value of this ASD tangent line where it crosses the vertical line at $\tau = 1$. See the example orange lines in Fig. \ref{fig:ASD_plot_N_B}.
